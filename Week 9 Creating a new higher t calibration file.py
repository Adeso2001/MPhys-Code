...
data2 = np.genfromtxt("Wk 9 Calibration.csv", delimiter = ',',
                         skip_header = 1)
...
ch1_voltage = ch5_voltage
ch2_voltage = ch6_voltage
...
ch2_time2 = ch2_time
ch3_time2 = ch3_time
ch0_voltage2 = ch4_voltage
ch1_voltage2 = ch5_voltage
ch2_voltage2 = ch6_voltage
...
output_figure1.savefig("week 9 lm334 and transistor hotter.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 9 VT graph LM334 hotter.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 9 VT graph transistor diode Hotter.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 9 VT graph transistor IN4002 Hotter.png",dpi = 1000,
                       bbox_inches = "tight")
...
vt_array_transistor = compute_average_temperature_and_uncertainty(
    ch1_voltage[1200:],temperature[1200:])
...
vt_array_IN4002_sliced = compute_average_temperature_and_uncertainty(
    temperature_sliced,ch2_voltage_sliced)
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 9 VT graph transistor diode Hotter sorted.png",dpi = 1000,
                       bbox_inches = "tight")
...
write_voltage_temperature_to_file(transistor_calibration_voltages, 
                                  transistor_calibration_temperatures)
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 9 VT graph transistor IN4002 Hotter sorted.png",dpi = 1000,
                       bbox_inches = "tight")
...
of.fit(IN4002_calibration_voltages,IN4002_calibration_temperatures,
       ...
       graph_filename = "IN4002 straight line fit wk9",
       function_returns = False,
       graph_legend = False,
       graph_title = "IN4002 straight line fit wk9",
       graph_font_size = 14)
...
pos = np.where(IN4002_calibration_unc_sliced != 0)
IN4002_calibration_voltages_sliced = IN4002_calibration_voltages_sliced[pos]
IN4002_calibration_temperatures_sliced = IN4002_calibration_temperatures_sliced[pos]
IN4002_calibration_unc_sliced = IN4002_calibration_unc_sliced[pos]

of.fit(IN4002_calibration_voltages_sliced,
       IN4002_calibration_temperatures_sliced,
       IN4002_calibration_unc_sliced,
       x_err = (IN4002_calibration_unc_sliced*0+0.00001),fit_type = 0,
       initial_guess = (0,0),
       fitting_method = 'odr',
       graph_xlabel = "Temperature $T$ (K)",
       graph_ylabel = "Voltage $V_D$ (V)",
       graph_filename = "IN4002 sliced straight line fit report",
       function_returns = False,
       graph_legend = False,
       graph_title = "",
