...
data2 = np.genfromtxt("lm334 in4002 combined circuit output 470Kohm + temp.csv", delimiter = ',',
                         skip_header = 1)
...
ch0_current = (ch0_voltage/470000) * (10**6)
...
output_figure1.savefig("week 8 lm334 and transistor offset test CURRENT 1.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("week 8 lm334 and transistor offset test 1 IT hot+cold.png",dpi = 1000,
                       bbox_inches = "tight")
...
ch0_current_slice = ch0_current[1500:]
...
output_figure1.tight_layout()
output_figure1.savefig("week 8 lm334 and transistor offset test 1 IT cold.png",dpi = 1000,
                       bbox_inches = "tight")
...
sorted_current = (sorted_voltage/470000) * (10 ** 6)
sorted_voltage_unc = VT_array[:,2]/2
sorted_current_unc = (sorted_voltage_unc/470000) * (10 ** 6)
...
ax.set_ylabel("Current (μA)")
ax.set_xlabel("Temperature (°K)")
ax.set_title("IT graph for IN4002 + LM334 combo trial 1")
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 8 IT graph transistor IN4002 + LM334 Sorted 1.png",dpi = 1000,
                       bbox_inches = "tight")
...
of.fit(sorted_temp,sorted_current,
       ...
       graph_filename = "IN4002 + LM334 straight line fit test 1",
       function_returns = False,
       graph_legend = False,
       graph_title = "IN4002 + LM334 straight line fit 1")
