...
data2 = np.genfromtxt("liquid nitrogen with calibrated diode longer alt.csv", delimiter = ',',
                         skip_header = 1)
...
temperature = temperature[500:11865]
calibrated_voltages = ch2_voltage2[500:11865]
transistor_voltages = ch0_voltage2[500:11865]
transistor_voltages_2 = ch3_voltage2[500:11865]
...
ax.scatter(temperature,calibrated_voltages, marker = '.', s = 5,
           label = "Calibrated Diode", zorder = 3, alpha = 0.7)
ax.scatter(temperature,transistor_voltages, marker = '.', s = 5,
           label = "Transistor Diode 1", zorder = 2, alpha = 0.7)
ax.scatter(temperature,transistor_voltages_2, marker = '.', s = 5,
           label = "Transistor Diode 2", zorder = 1, alpha = 0.7)
ax.legend()

output_figure1.tight_layout()
output_figure1.savefig("VT graph.png",dpi = 1000,
                       bbox_inches = "tight")
