...
data1 = np.genfromtxt("Thermal coef test 3 60sec 200kohm.csv", skip_header=1,
                      delimiter =',')
...
ax.set_title("Voltage Against Time LM334 & Diode Trial 3")
...
output_figure1.savefig("Wk6 thermal coef trial3.png",dpi = 1000,
                       bbox_inches = "tight")
