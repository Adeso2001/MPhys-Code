...
output_figure1.savefig("week 8 lm334 and transistor offset test 1.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("week 8 lm334 and transistor offset test 1 VT hot+cold.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("week 8 lm334 and transistor offset test 1 VT cold.png",dpi = 1000,
                       bbox_inches = "tight")
...
ax.set_title("VT graph for IN4002 + LM334 combo trial 1")
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 8 VT graph transistor IN4002 + LM334 Sorted 1.png",dpi = 1000,
                       bbox_inches = "tight")
