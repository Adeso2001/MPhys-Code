...
if test == 4:
    ...
    file_name = "reading 3-12-24 11-15 122kohm.csv"
elif test == 12:
    file_name = "reading 3-12-24 11-15 122kohm.csv"
...
#ch1_temperature_slice = ch1_temperature[1400:8175]
ch1_temperature_slice = temperature[2500:6175]
ch0_voltage_slice = ch0_voltage[2500:6175]
ch5_voltage_slice = ch5_voltage[2500:6175]
ch0_current_slice = ch0_current[2500:6175]
...
of.fit(sorted_temp,sorted_current,
       ...
       graph_legend = False,
       graph_title = f"IN4002 + LM334 straight line fit {test} wk9")
...
of.fit(sorted_temp,sorted_current,
       ...
       graph_ylabel = "Current $I_{set}$ (μA)",
       graph_filename = "Report Independent current gen",
       function_returns = False,
       graph_legend = False,
       graph_title = "",
       graph_font_size = 18)
