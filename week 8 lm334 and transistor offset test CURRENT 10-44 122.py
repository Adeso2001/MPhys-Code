...
output_figure1.savefig("week 8 lm334 and transistor offset test CURRENT 2.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("week 8 lm334 and transistor offset test 2 IT hot+cold.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("week 8 lm334 and transistor offset test 2 IT cold.png",dpi = 1000,
                       bbox_inches = "tight")
...
ax.set_ylabel("Current (μA)")
ax.set_xlabel("Temperature (°K)")
ax.set_title("IT graph for IN4002 + LM334 combo trial 2")
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 8 IT graph transistor IN4002 + LM334 Sorted 2.png",dpi = 1000,
                       bbox_inches = "tight")
...
of.fit(sorted_temp,sorted_current,
       ...
       graph_filename = "IN4002 + LM334 straight line fit test 2",
       function_returns = False,
       graph_legend = False,
       graph_title = "IN4002 + LM334 straight line fit 2")
