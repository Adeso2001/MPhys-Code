...
data2 = np.genfromtxt("lm334 in4002 combined circuit output 470Kohm + temp 10-75 117-5.csv", delimiter = ',',
                         skip_header = 1)
...
output_figure1.savefig("week 8 lm334 and transistor offset test CURRENT 3.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("week 8 lm334 and transistor offset test 3 IT hot+cold.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("week 8 lm334 and transistor offset test 3 IT cold.png",dpi = 1000,
                       bbox_inches = "tight")
...
output_figure1.tight_layout()
output_figure1.savefig("Wk 8 IT graph transistor IN4002 + LM334 Sorted 3.png",dpi = 1000,
                       bbox_inches = "tight")
...
of.fit(sorted_temp,sorted_current,
       ...
       graph_filename = "IN4002 + LM334 straight line fit test 3",
       function_returns = False,
       graph_legend = False,
       graph_title = "IN4002 + LM334 straight line fit 3")
